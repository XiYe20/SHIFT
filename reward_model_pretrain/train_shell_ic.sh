...
CLOUD_DATASET="/path/to/wisa80k_correct.tar.gz"


# =========================================================
# Cross-node barrier (shared filesystem)
# =========================================================
BARRIER_DIR="/path/to/checkpoints/WISA80K_Deformation_IC_Reward_Vit_Base_49x704x1280_fps24_ds2/_barrier"
...
accelerate launch \
    ...
    train_ic_discriminator.py \
    --config ./configs/ic_discriminator_train_config.yaml \
    --report_to tensorboard


# CUDA_VISIBLE_DEVICES=0 accelerate launch --num_processes 1 --main_process_port 29514 train_ic_discriminator.py --config ./configs/ic_discriminator_train_config.yaml --report_to tensorboard
# CUDA_VISIBLE_DEVICES=2,3,4,5,6,7,8,9 python /path/to/eval_phyvid.py --master_port 12491