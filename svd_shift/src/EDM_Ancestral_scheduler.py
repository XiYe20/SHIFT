...
class EDMAncestralSchedulerOutput(BaseOutput):
    """
...
class EDMAncestralScheduler(EulerDiscreteScheduler):
    """
    `EDMAncestralScheduler` is a modification of `EulerDiscreteScheduler` where the `step` function takes in `model_output` as well
    ...
    def step(
    ...
    ) -> Union[EDMAncestralSchedulerOutput, Tuple]:
        """
        ...
        return EDMAncestralSchedulerOutput(prev_sample=prev_sample, 
